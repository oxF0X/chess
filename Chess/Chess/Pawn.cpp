...
int Pawn::isValidMove(const int& row, const int& col)
{
	...
	bool valid7 = ((this->_row - row == 1 ) && (abs(this->_col - col) == 1) && (this->_boardPtr->isEmpty(row - 1, col)) && (this->getColor() == WHITE) && 
	...
	bool valid8 = ((this->_row - row == -1) && (abs(this->_col - col) == 1) && (this->_boardPtr->isEmpty(5, col)) && (this->getColor() == BLACK) 
